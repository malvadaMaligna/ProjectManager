<?php
	...
	class BlogMdl{
		...
		public function getBlogEntries(){
			...
			$result = $this -> connection -> query( $query ) or die(  "DB Error: BlogMdl.getBlogEntries: Error " );
			return $result;
		}
		...
		public function getPojectBlogEntries( $idProject ){
			...
			$result = $this -> connection -> query( $query ) or die(  "DB Error: BlogMdl.getPojectBlogEntries: Error " );
			return $result;
		}
		...
		public function getProjectBlogUsers( $idProject ){
			...
			$result = $this -> connection -> query( $query ) or die(  "DB Error: BlogMdl.getProjectBlogUsers: Error " );
			return $result;
		}
	}
